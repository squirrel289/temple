...
notes: |
  ...
  The adapter currently emits Jinja compare op tokens (eq/gteq/etc.) instead of
  Temple/Python operators, which can break semantic analysis for common conditions.
---
