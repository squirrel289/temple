...
class TestErrorFormatter:
    ...
    def test_format_with_context(self):
        ...
        diag = Diagnostic(
            message="Error here",
            source_range=SourceRange(Position(1, 0), Position(1, 4)),
            code="TEST_001"
        )
    ...
    def test_format_multiple_diagnostics(self):
        ...
        diagnostics = [
            Diagnostic("Error 1", SourceRange(Position(0, 0), Position(0, 4)), 
                      severity=DiagnosticSeverity.ERROR, code="E001"),
            Diagnostic("Warning 1", SourceRange(Position(1, 0), Position(1, 4)), 
    ...
    def test_format_long_line(self):
        ...
        diag = Diagnostic(
            ...
            source_range=SourceRange(Position(0, 50), Position(0, 55))
        )
...
class TestFormatterIntegration:
    ...
    def test_format_error_with_all_fields(self):
        ...
        diag = Diagnostic(
            ...
            source_range=SourceRange(Position(0, 4), Position(0, 18)),
