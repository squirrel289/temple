...
class YAMLSerializer(Serializer):
    ...
    def __init__(self, pretty: bool = True, strict: bool = False, flow_style: bool = False):
        """
    ...
    def serialize(self, ast: ASTNode, data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            raise SerializationError(f"YAML serialization error: {str(e)}", ast.source_range)
